...
PTA = planta.PlantaTratamiento(name="Tamaya", altitude=288, location=(-30.5770162571, -71.4047606976),
                               ...
                               fact_cap_inst_2=0, capacidad_instalada1=138, capacidad_instalada2=500,
...
'''redd = [n * (1 / 1000000) for n in PTA.cost_months_energy_pta_grid]
autogen = [n * (1 / 1000000) for n in PTA.cost_months_energy_pta_pvs_grid]
ntbg = [n * (1 / 1000000) for n in PTA.cost_months_energy_pta_pvs_ntbg]
